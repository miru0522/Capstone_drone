...
# ★2026-09-03: 기본 해상도를 캡처 파이프라인 네이티브 해상도(1280x720, main.py
# CAMERA_WIDTH/HEIGHT와 동일)까지 상향. 이보다 크게 요청해도 main.py의
# cv2.resize가 원본 프레임을 업스케일할 뿐 실제 화질 이득은 없음.
STREAM_DEFAULT_FPS = 5
STREAM_DEFAULT_WIDTH = 1280
